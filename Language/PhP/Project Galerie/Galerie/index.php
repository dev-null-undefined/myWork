...
<body>
    ...
    <div class="container">
        <div class="gallery">
            ...
            function processimg($filename, $newFile)
            {
                ...
                imagejpeg($imagetruecolor, $newFile, 75);
            };
            ...
            while ($row = mysqli_fetch_array($selectResoult)) {
                if ($dirSeted) {
                    echo '<a oncontextmenu="folderContextMenu()" class="imgContainer" href="index.php?DIR=' . $dir . '/' . $row['Nazev'] .
                        '"><img class="folder" src="./WebPageStufTopSecret/folder.png">' .
                        '<div class="text-block">' . $row['Nazev'] . '</div>' . '</a>';
                } else {
                    echo '<a oncontextmenu="folderContextMenu()" class="imgContainer" href="index.php?DIR=' . $row['Nazev'] .
                        '"><img class="folder" src="./WebPageStufTopSecret/folder.png">' .
                        '<div class="text-block">' . $row['Nazev'] . '</div>' . '</a>';
                }
            }
    ...
    <div id="imageMenu" class="contextMenu">
